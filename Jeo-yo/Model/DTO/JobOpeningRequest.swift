...
struct Message: Codable {
    ...
    static func setMessage(_ message: String) -> [Message] {
        let order = message + """
            당신은 채용 공고를 분석하는 역할을 맡았습니다. 회사명, 모집 기간 그리고 채용 공고의 전형별 절차를 분류헤야합니다. 날짜는 yyyy의 형태로 맞추어야합니다, 가급적이면 공고에 있는 내용만을 사용해야합니다. 사족을 붙이지 말고 아래의 struct 타입에 맞춘 JSON으로 응답을 보내야합니다.
